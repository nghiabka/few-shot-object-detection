...
EXP_NAME=$1
SAVE_DIR=/content/drive/MyDrive/few_shot_learning/out20221309/voc/${EXP_NAME}
IMAGENET_PRETRAIN=/content/ImageNetPretrained/MSRA/R-101.pkl                            # <-- change it to you path
IMAGENET_PRETRAIN_TORCH=/content/ImageNetPretrained/torchvision/resnet101-5d3b4d8f.pth  # <-- change it to you path
SPLIT_ID=$2
